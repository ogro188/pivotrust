...
//+------------------------------------------------------------------+
#property copyright "PivotRadar USDJPY | Calibrado: 2026-07-24 20:01"
#property version   "7.70"
#property strict

//+------------------------------------------------------------------+
//| CALIBRACION AUTOMATICA -- USDJPY
//| Generado: 2026-07-24 20:01
//| Par con 2-3 decimales, movimientos más granulares, sesiones asiáticas relevantes.
//| EMA Fast: 21 | EMA Slow: 50
//| ATR Compresion: 0.85 | Expansion: 1.25
//| Probabilidades: D1=66% D2=71% D3=66% D4=66% D5=76%
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//| INPUTS                                                          |
//+------------------------------------------------------------------+
...
input int      InpN_Ruptura   = 5;
input double   InpD1_ATRThreshold = 0.45;
input double   InpBodyRatio_Min = 0.35;
input bool     InpD1_UseRetest = true;
input bool     InpD1_UseVolume = true;
input double   InpD1_MinVolume = 1.1;

//--- D2 (Liquidity Sweep + Reclaim) - INTRAVELA
input int      InpSweep_N     = 6;
input double   InpSweepWickMin = 0.5;
input double   InpReclaimBodyMin = 0.5;
input int      InpEqualHL_Window = 12;
input double   InpEqualHL_Tol = 0.12;
input bool     InpD2_Anticipar = true;

//--- D3 (Fair Value Gap) - INTRAVELA
input double   InpFVG_MinSizeATR = 0.18;
input double   InpFVG_BodyRatio = 0.5;
input double   InpFVG_MitigUmbral = 0.45;

//--- D4 (Order Block) - INTRAVELA
input int      InpOB_Lookback = 14;
input double   InpOB_BodyMin = 0.35;
input double   InpOB_ImpulseMin = 0.6;

//--- D5 (MSS H4 + Sweep) - INTRAVELA
input int      InpMSS_LookbackH4 = 24;
input int      InpMSS_MaxAgeH4Bars = 14;

//--- D0 (Estructura)
input int      InpPivotDepth = 2;
input int      InpPivotLookback = 24;
input double   InpSweepDistancia = 1.2;
input double   InpZonaMargen = 0.4;
