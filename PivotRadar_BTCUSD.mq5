...
//+------------------------------------------------------------------+
#property copyright "PivotRadar BTCUSD | Calibrado: 2026-07-24 20:01"
#property version   "7.70"
#property strict

//+------------------------------------------------------------------+
//| CALIBRACION AUTOMATICA -- BTCUSD
//| Generado: 2026-07-24 20:01
//| Cripto, alta volatilidad, gaps, spreads variables. Umbrales muy altos, vencimientos largos.
//| EMA Fast: 21 | EMA Slow: 50
//| ATR Compresion: 0.65 | Expansion: 1.8
//| Probabilidades: D1=58% D2=62% D3=58% D4=58% D5=65%
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//| INPUTS                                                          |
//+------------------------------------------------------------------+
...
input double   InpD1_ATRThreshold = 1.0;
input double   InpBodyRatio_Min = 0.3;
input bool     InpD1_UseRetest = true;
input bool     InpD1_UseVolume = true;
input double   InpD1_MinVolume = 1.8;

//--- D2 (Liquidity Sweep + Reclaim) - INTRAVELA
input int      InpSweep_N     = 6;
input double   InpSweepWickMin = 0.7;
input double   InpReclaimBodyMin = 0.7;
input int      InpEqualHL_Window = 6;
input double   InpEqualHL_Tol = 0.3;
input bool     InpD2_Anticipar = true;

//--- D3 (Fair Value Gap) - INTRAVELA
input double   InpFVG_MinSizeATR = 0.5;
input double   InpFVG_BodyRatio = 0.5;
input double   InpFVG_MitigUmbral = 0.65;

//--- D4 (Order Block) - INTRAVELA
input int      InpOB_Lookback = 6;
input double   InpOB_BodyMin = 0.3;
input double   InpOB_ImpulseMin = 1.5;

//--- D5 (MSS H4 + Sweep) - INTRAVELA
input int      InpMSS_LookbackH4 = 10;
input int      InpMSS_MaxAgeH4Bars = 6;

//--- D0 (Estructura)
input int      InpPivotDepth = 2;
input int      InpPivotLookback = 24;
input double   InpSweepDistancia = 2.5;
input double   InpZonaMargen = 1.0;
