...
/// Umbrales heurísticos calibrados manualmente en EURUSD 2024 (EA v7.6).
...
/// Clasificación D2: A requiere wick>0.70, vol>1.80, reclaim>0.70 + equal_hl.
/// Fuente: EA v7.6, criterios heurísticos calibrados manualmente en EURUSD 2024.
...
/// Clasificación D2 anticipación: A requiere ≥3 confluencias, wick>0.65, vol>1.50.
/// Fuente: EA v7.6, criterios heurísticos calibrados manualmente en EURUSD 2024.
...
/// Clasificación D3: A requiere FVG>0.50 ATR, br>0.70, tendencia ≥3 velas.
/// Fuente: EA v7.6, criterios heurísticos calibrados manualmente en EURUSD 2024.
...
/// Clasificación D4: A requiere impulso>1.80, vol>1.50, OB ≤6 velas.
/// Fuente: EA v7.6, criterios heurísticos calibrados manualmente en EURUSD 2024.
...
/// Clasificación D5: A requiere MSS≤4 velas, wick>0.70, reclaim>0.70 en kill zone.
/// Fuente: EA v7.6, criterios heurísticos calibrados manualmente en EURUSD 2024.
