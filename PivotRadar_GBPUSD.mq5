...
//+------------------------------------------------------------------+
#property copyright "PivotRadar GBPUSD | Calibrado: 2026-07-24 20:01"
#property version   "7.70"
#property strict

//+------------------------------------------------------------------+
//| CALIBRACION AUTOMATICA -- GBPUSD
//| Generado: 2026-07-24 20:01
//| Par volátil, movimientos amplios, spreads ligeramente superiores a EURUSD.
//| EMA Fast: 21 | EMA Slow: 50
//| ATR Compresion: 0.75 | Expansion: 1.35
//| Probabilidades: D1=63% D2=68% D3=63% D4=63% D5=73%
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//| INPUTS                                                          |
//+------------------------------------------------------------------+
...
input int      InpN_Ruptura   = 4;
input double   InpD1_ATRThreshold = 0.6;
input double   InpBodyRatio_Min = 0.45;
input bool     InpD1_UseRetest = true;
input bool     InpD1_UseVolume = true;
input double   InpD1_MinVolume = 1.3;

//--- D2 (Liquidity Sweep + Reclaim) - INTRAVELA
input int      InpSweep_N     = 6;
input double   InpSweepWickMin = 0.6;
input double   InpReclaimBodyMin = 0.6;
input int      InpEqualHL_Window = 8;
input double   InpEqualHL_Tol = 0.2;
input bool     InpD2_Anticipar = true;

//--- D3 (Fair Value Gap) - INTRAVELA
input double   InpFVG_MinSizeATR = 0.25;
input double   InpFVG_BodyRatio = 0.6;
input double   InpFVG_MitigUmbral = 0.55;

//--- D4 (Order Block) - INTRAVELA
input int      InpOB_Lookback = 10;
input double   InpOB_BodyMin = 0.45;
input double   InpOB_ImpulseMin = 0.8;

//--- D5 (MSS H4 + Sweep) - INTRAVELA
input int      InpMSS_LookbackH4 = 16;
input int      InpMSS_MaxAgeH4Bars = 10;

//--- D0 (Estructura)
input int      InpPivotDepth = 2;
input int      InpPivotLookback = 24;
input double   InpSweepDistancia = 1.8;
input double   InpZonaMargen = 0.6;
