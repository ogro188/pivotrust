...
//+------------------------------------------------------------------+
#property copyright "PivotRadar EURUSD | Calibrado: 2026-07-24 20:01"
#property version   "7.70"
#property strict

//+------------------------------------------------------------------+
//| CALIBRACION AUTOMATICA -- EURUSD
//| Generado: 2026-07-24 20:01
//| Par mayor, spread bajo, volatilidad media. Calibración conservadora.
//| EMA Fast: 21 | EMA Slow: 50
//| ATR Compresion: 0.8 | Expansion: 1.3
//| Probabilidades: D1=65% D2=70% D3=65% D4=65% D5=75%
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
//| INPUTS                                                          |
//+------------------------------------------------------------------+
...
input double   InpD1_ATRThreshold = 0.5;
input double   InpBodyRatio_Min = 0.4;
input bool     InpD1_UseRetest = true;
input bool     InpD1_UseVolume = true;
input double   InpD1_MinVolume = 1.2;

//--- D2 (Liquidity Sweep + Reclaim) - INTRAVELA
input int      InpSweep_N     = 6;
input double   InpSweepWickMin = 0.55;
input double   InpReclaimBodyMin = 0.55;
input int      InpEqualHL_Window = 10;
input double   InpEqualHL_Tol = 0.15;
input bool     InpD2_Anticipar = true;

//--- D3 (Fair Value Gap) - INTRAVELA
input double   InpFVG_MinSizeATR = 0.2;
input double   InpFVG_BodyRatio = 0.55;
input double   InpFVG_MitigUmbral = 0.5;

//--- D4 (Order Block) - INTRAVELA
input int      InpOB_Lookback = 12;
input double   InpOB_BodyMin = 0.4;
input double   InpOB_ImpulseMin = 0.7;

//--- D5 (MSS H4 + Sweep) - INTRAVELA
input int      InpMSS_LookbackH4 = 20;
input int      InpMSS_MaxAgeH4Bars = 12;

//--- D0 (Estructura)
input int      InpPivotDepth = 2;
input int      InpPivotLookback = 24;
input double   InpSweepDistancia = 1.5;
input double   InpZonaMargen = 0.5;
